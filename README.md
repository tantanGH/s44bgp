...
高速ビュワー系などの一部のアプリケーションで特定の操作を行った際に PCM8PP.X の再生が停止されてしまう場合があります。(mintテキストビュワーのスムーススクロールなど)

この時 S44BGP.X は曲が終わったと認識して次の曲に進んでしまいます。

現時点で原因ははっきりしていませんので、この点ご承知おきください。
